<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            <a href="{{route('admin.dashboard')}}" class="nav-item nav-link @if(Request::url() == route('admin.dashboard')) active @endif"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle @if(Request::url() == route('user.index')) active @endif" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-user-alt me-2"></i>Data User</a>
